...
declare -A COMPONENTS=(
    ...
    # MaaS: integrated-maas-modularization feature branch (includes PR #1052 + #1025)
    [maascontroller]="models-as-a-service|deployment/base/maas-controller|74526c8b|74526c8b"
)
